...
<div class="container mx-auto py-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('confirmarCompra', ['id' => $plano->id]) }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="endereco" name="endereco" class="w-full border-gray-300 rounded-lg py-2 px-4"
                    required>
            </div>
        ...
        <a href="{{ route('comprar.planos') }}"
            class="w-full block mt-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-lg text-center">
            Voltar para Planos
        </a>
    </div>
</div>
